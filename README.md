...
The dashboard was built using Python, Streamlit, Plotly, and XGBoost, with a strong focus on interactive visualization, business intelligence, and predictive analytics.
